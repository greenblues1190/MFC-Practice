...
// ChatProgram.cpp: 응용 프로그램에 대한 클래스 동작을 정의합니다.
//
...
void CChatProgramApp::InitServer()
{
	// TODO: 여기에 구현 코드 추가.
...
{
	// TODO: 여기에 구현 코드 추가.
	AfxMessageBox(_T("Connecting to ") + strIP);
	m_pClient = new CClientSock;
	m_pClient->Create();
...
void CChatProgramApp::ReceiveData()
{
	// TODO: 여기에 구현 코드 추가.
	wchar_t temp[MAX_PATH];
	m_pClient->Receive(temp, sizeof(temp));
	((CChatProgramDlg*)m_pMainWnd)->ReceiveData(temp);
}
...
void CChatProgramApp::CloseChild()
{
	// TODO: 여기에 구현 코드 추가.

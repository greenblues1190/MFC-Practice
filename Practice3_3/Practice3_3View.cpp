...
CPractice33View::CPractice33View() noexcept : m_strOutput(_T("Type anything")), m_ptLocation(0)
{
...
void CPractice33View::OnKeyDown(UINT nChar, UINT nRepCnt, UINT nFlags)
{
	...
	{
		m_ptLocation.y = 0;
		AfxMessageBox(_T("위로 더 이상 이동할 수 없습니다."));
	}
	...
	{
		m_ptLocation.x = m_ptClientSize.y;
		AfxMessageBox(_T("아래로 더 이상 이동할 수 없습니다."));
	}

...
CPractice2_1View::CPractice2_1View() noexcept
{
...
void CPractice2_1View::OnDraw(CDC* pDC)			// 주석 처리 해제
{
...
void CPractice2_1View::OnSize(UINT nType, int cx, int cy)
{
...
void CPractice2_1View::OnLButtonDown(UINT nFlags, CPoint point)
{
...
void CPractice2_1View::OnRButtonDown(UINT nFlags, CPoint point)
{
	// TODO: 여기에 메시지 처리기 코드를 추가 및/또는 기본값을 호출합니다.
...
void CPractice2_1View::OnKeyDown(UINT nChar, UINT nRepCnt, UINT nFlags)
{
	// TODO: 여기에 메시지 처리기 코드를 추가 및/또는 기본값을 호출합니다.
...
void CPractice2_1View::OnMouseMove(UINT nFlags, CPoint point)
{
	// TODO: 여기에 메시지 처리기 코드를 추가 및/또는 기본값을 호출합니다.
...
void CPractice2_1View::OnLButtonUp(UINT nFlags, CPoint point)
{
	// TODO: 여기에 메시지 처리기 코드를 추가 및/또는 기본값을 호출합니다.
	m_bDrag = FALSE;
